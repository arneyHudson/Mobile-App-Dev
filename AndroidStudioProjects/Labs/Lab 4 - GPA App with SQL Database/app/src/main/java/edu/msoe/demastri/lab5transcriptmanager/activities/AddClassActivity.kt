...
import edu.msoe.demastri.lab5transcriptmanager.database.MSOECourseDatabase
import edu.msoe.demastri.lab5transcriptmanager.R
import edu.msoe.demastri.lab5transcriptmanager.R.*
import edu.msoe.demastri.lab5transcriptmanager.R.id.*
import edu.msoe.demastri.lab5transcriptmanager.database.DatabaseHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseNameInput.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                val credits = MSOECourseDatabase.getCourseCreditMap()[enteredCourseName]
